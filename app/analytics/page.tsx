...
import { TrendingUp, Music, Calendar, Users, Loader2 } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl font-bold">Musik Analytics</h1>
                <p className="text-gray-400">Entdecke die Geheimnisse deines Musikgeschmacks</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-400 text-sm">Ø Release</p>
                      <p className="text-white text-xl font-bold">
                        {tracks.length > 0 ? 
                          Math.round(tracks.reduce((sum, t) => 
                            sum + new Date(t.album.release_date).getFullYear(), 0
                          ) / tracks.length) : 'N/A'
                        }
                      </p>
                    </div>
